...
class MapViewController: UIViewController, MKMapViewDelegate {
    ...
    @IBOutlet weak var parkingSegmentController: UISegmentedControl!
    ...
    @IBAction func mapListSwitch(sender: AnyObject) {
        switch parkingSegmentController.selectedSegmentIndex
        {
        case 0:
            break
        ...
        case 1:
            ...
            let parkingListTableViewController = self.storyboard!.instantiateViewControllerWithIdentifier("ParkingListTabViewController")
            
            self.presentViewController(parkingListTableViewController, animated: true, completion: nil)
