...
class Deck: parkingSpot {
    ...
    static var sDeck = Deck(detailInfo: "General Information S Deck is located at Gilmer Street. S Deck has no reserved handicap accessible spots. There is no elevator to maneuver between floors. Hours 6:30am – 10:00pm. No overnight parking.")
